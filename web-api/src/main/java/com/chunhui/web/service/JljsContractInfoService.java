...
public Result
<PageResult
<JljsContractInfoOutVO>> pageList(JljsContractInfoQuery query) {
    return ResultGenerator.success(PageUtil.pageResult(jljsContractInfoDao.pageListByQurey(query),
    commonConvert::toJljsContractInfoOutList));
    }

    public Result
    <JljsContractInfoOutVO> detail(String id) {
        return ResultGenerator.success(commonConvert.toJljsContractInfoListOut(jljsContractInfoDao.getById(id)));
        }

        public Result
        <String> save(JljsContractInfoSaveVO saveVO) {
            jljsContractInfoDao.save(commonConvert.toJljsContractInfo(saveVO));
            return ResultGenerator.success();
            }

            public Result
            <String> update(JljsContractInfoUpdateVO updateVO) {
