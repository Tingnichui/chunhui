...
public class JljsCoachInfoController {
    ...
    public Result<PageResult<JljsCoachInfoOutVO>> regist(@RequestBody JljsCoachInfoQuery query) {
    ...
    @RequestMapping("/save")
    public Result<String> save(@RequestBody JljsCoachInfoSaveVO saveVO) {
        return jljsCoachInfoService.save(saveVO);
    }


    @RequestMapping("/update")
    public Result<String> update(@RequestBody JljsCoachInfoUpdateVO updateVO) {
