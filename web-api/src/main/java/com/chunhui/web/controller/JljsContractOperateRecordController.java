...
public Result<PageResult<JljsContractOperateRecordOutVO>> regist(@RequestBody JljsContractOperateRecordQuery query) {
...
@RequestMapping("/save")
public Result<String> save(@RequestBody JljsContractOperateRecordSaveVO saveVO) {
return jljsContractOperateRecordService.save(saveVO);
}


@RequestMapping("/update")
public Result<String> update(@RequestBody JljsContractOperateRecordUpdateVO updateVO) {
