...
import com.chunhui.web.service.JljsClassRecordService;
...
public class JljsClassRecordController {
    ...
    public Result<PageResult<JljsClassRecordOutVO>> regist(@RequestBody JljsClassRecordQuery query) {
    ...
    @RequestMapping("/save")
    public Result<String> save(@RequestBody JljsClassRecordSaveVO saveVO) {
        return jljsClassRecordService.save(saveVO);
    }


    @RequestMapping("/update")
    public Result<String> update(@RequestBody JljsClassRecordUpdateVO updateVO) {
