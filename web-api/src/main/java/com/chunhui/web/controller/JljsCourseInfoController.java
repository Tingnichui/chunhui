...
public class JljsCourseInfoController {
    ...
    public Result<PageResult<JljsCourseInfoOutVO>> regist(@RequestBody JljsCourseInfoQuery query) {
    ...
    @RequestMapping("/save")
    public Result<String> save(@RequestBody JljsCourseInfoSaveVO saveVO) {
        return jljsCourseInfoService.save(saveVO);
    }


    @RequestMapping("/update")
    public Result<String> update(@RequestBody JljsCourseInfoUpdateVO updateVO) {
