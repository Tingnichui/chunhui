...
public class DbUtil {
    ...
    private static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://192.168.10.2:3306/chunhui?useUnicode=true&serverTimezone=Asia/Shanghai&characterEncoding=utf8&autoReconnect=true&useSSL=false&allowMultiQueries=true&useAffectedRows=true";
            String user = "test";
     ...
     */
    public static List<Field> getColumnByTableName(String tableName, List<String> ignoreFields) throws Exception {
